import AUTHORIZATION_KEY from '@/api/authorization-key'

import {
  /* Creating authorization_key flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
  ...
  /* Reading authorization_key flow */
  READ_BEGIN,
  READ_SUCCESS,
  READ_FAILURE,
  READ_SET_MESSAGES,
  ...
  /* Updating authorization_key flow */
  UPDATE_BEGIN,
  UPDATE_SUCCESS,
  UPDATE_FAILURE,
  UPDATE_SET_MESSAGES,
  ...
  /* Deleting authorization_key flow */
  DELETE_BEGIN,
  DELETE_SUCCESS,
  DELETE_FAILURE,
  DELETE_SET_MESSAGES,
  ...
  /* Listing authorization_key flow */
  LIST_BEGIN,
  LIST_SUCCESS,
  LIST_FAILURE,
  LIST_SET_MESSAGES,
  ...
  /* Schemating authorization_key flow */
  SCHEMA_BEGIN,
  SCHEMA_SUCCESS,
  SCHEMA_FAILURE,
  SCHEMA_SET_MESSAGES,
