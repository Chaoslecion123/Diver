import COUNTRY_AREA from '@/api/country-area'

import {
  /* Creating country_area flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
