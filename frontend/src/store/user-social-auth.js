import USER_SOCIAL_AUTH from '@/api/user-social-auth'

import {
  /* Creating user_social_auth flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
  ...
  /* Updating user_social_auth flow */
  UPDATE_BEGIN,
  UPDATE_SUCCESS,
  UPDATE_FAILURE,
  UPDATE_SET_MESSAGES,
  ...
  /* Deleting user_social_auth flow */
  DELETE_BEGIN,
  DELETE_SUCCESS,
  DELETE_FAILURE,
  DELETE_SET_MESSAGES,
  ...
  /* Schemating user_social_auth flow */
  SCHEMA_BEGIN,
  SCHEMA_SUCCESS,
  SCHEMA_FAILURE,
  SCHEMA_SET_MESSAGES,
