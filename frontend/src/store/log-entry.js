import LOG_ENTRY from '@/api/log-entry'

import {
  /* Creating log_entry flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
