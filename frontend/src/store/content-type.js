import CONTENT_TYPE from '@/api/content-type'

import {
  /* Creating content_type flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
