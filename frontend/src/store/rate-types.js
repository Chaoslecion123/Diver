import RATE_TYPES from '@/api/rate-types'

import {
  /* Creating rate_types flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
