import SHIPPING_ZONE from '@/api/shipping-zone'

import {
  /* Creating shipping_zone flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
