import PARTIAL from '@/api/partial'

import {
  /* Creating partial flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
