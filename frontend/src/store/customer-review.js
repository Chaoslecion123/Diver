import CUSTOMER_REVIEW from '@/api/customer-review'

import {
  /* Creating customer_note flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
