import SHIPPING_METHOD from '@/api/shipping-method'

import {
  /* Creating shipping_method flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
  ...
  /* Schemating shipping_method flow */
  SCHEMA_BEGIN,
  SCHEMA_SUCCESS,
  SCHEMA_FAILURE,
  SCHEMA_SET_MESSAGES,
...
const actions = {
  create ({ commit }, { data, config = {} } = {}) {
    ...
    return SHIPPING_METHOD.create(data, config)
      .then(response => {
  ...
  read ({ commit }, { id, query = {}, config = {} } = {}) {
    ...
    return SHIPPING_METHOD.retrieve(id, query, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  update ({ commit }, { id, data, config = {} } = {}) {
    ...
    return SHIPPING_METHOD.update(id, data, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  delete ({ commit }, { id, config = {} } = {}) {
    ...
    return SHIPPING_METHOD.delete(id, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  list ({ commit }, { query = {}, config = {} } = {}) {
    ...
    return SHIPPING_METHOD.list(query, config)
      .then(response => {
  ...
  schema ({ commit }, { config = {} } = {}) {
    ...
    return SHIPPING_METHOD.options(config)
      .then(response => {
