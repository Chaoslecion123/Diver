import SITE_SETTINGS from '@/api/site-settings'

import {
  /* Creating site_settings flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
