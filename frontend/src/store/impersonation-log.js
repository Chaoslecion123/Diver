import IMPERSONATION_LOG from '@/api/impersonation-log'

import {
  /* Creating impersonation_log flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
  ...
  /* Reading impersonation_log flow */
  READ_BEGIN,
  READ_SUCCESS,
  READ_FAILURE,
  READ_SET_MESSAGES,
  ...
  /* Updating impersonation_log flow */
  UPDATE_BEGIN,
  UPDATE_SUCCESS,
  UPDATE_FAILURE,
  UPDATE_SET_MESSAGES,
  ...
  /* Deleting impersonation_log flow */
  DELETE_BEGIN,
  DELETE_SUCCESS,
  DELETE_FAILURE,
  DELETE_SET_MESSAGES,
  ...
  /* Listing impersonation_log flow */
  LIST_BEGIN,
  LIST_SUCCESS,
  LIST_FAILURE,
  LIST_SET_MESSAGES,
  ...
  /* Schemating impersonation_log flow */
  SCHEMA_BEGIN,
  SCHEMA_SUCCESS,
  SCHEMA_FAILURE,
  SCHEMA_SET_MESSAGES,
