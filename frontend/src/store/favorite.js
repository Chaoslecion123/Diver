...
const actions = {
  create ({ commit }, { data, config = {} } = {}) {
    ...
    return FAVORITE.create(data, config)
      .then(response => {
  ...
  read ({ commit }, { id, query = {}, config = {} } = {}) {
    ...
    return FAVORITE.retrieve(id, query, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  update ({ commit }, { id, data, config = {} } = {}) {
    ...
    return FAVORITE.update(id, data, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  delete ({ commit }, { id, config = {} } = {}) {
    ...
    return FAVORITE.delete(id, config)
      .then(response => {
        commit(SET_OBJECT, response.data)
      })
      .then(() => {
  ...
  list ({ commit }, { query = {}, config = {} } = {}) {
    ...
    return FAVORITE.list(query, config)
      .then(response => {
  ...
  schema ({ commit }, { config = {} } = {}) {
    ...
    return FAVORITE.options(config)
      .then(response => {
