import CITY_AREA from '@/api/city-area'

import {
  /* Creating city_area flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
