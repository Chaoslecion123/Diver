import VARIANT_IMAGE from '@/api/variant-image'

import {
  /* Creating variant_image flow */
  CREATE_BEGIN,
  CREATE_SUCCESS,
  CREATE_FAILURE,
  CREATE_SET_MESSAGES,
