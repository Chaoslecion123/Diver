...
from ..checkout import ShippingType, BillingType
from . import FulfillmentStatus, OrderEvents, OrderStatus, OrderShippingStatus
...
class Order(models.Model):
    ...
    shipping_price.serialize = False
