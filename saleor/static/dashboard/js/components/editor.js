...
import EditorTableExtension from './editor-table';
...
import listBulleted from '../../images/editor/list_bulleted.svg';
import listNumbered from '../../images/editor/list_numbered.svg';
...
const editor = new MediumEditor('.rich-text-editor', {
  ...
  toolbar: {
    buttons: [
      ...
      },
      {
        ...
        aria: pgettext('Rich text editor option', 'Ordered list'),
        // tagNames: ['ol'],
        // useQueryState: true,
        contentDefault: `<img src="${listNumbered}">`
      },
      {
        name: 'unorderedlist',
        // action: 'insertunorderedlist',
        aria: pgettext('Rich text editor option', 'Unordered list'),
        // tagNames: ['ul'],
        // useQueryState: true,
        contentDefault: `<img src="${listBulleted}">`
      },
      {
        name: 'removeFormat',
  ...
  extensions: {
    table: new EditorTableExtension()
  }
});
