...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/update/dashboard/$', views.dashboard_style_settings_edit,
        name='site-dashboard-update'),
    url(r'^(?P<pk>\d+)/update/store/$', views.store_style_settings_edit,
        name='site-store-update'),
    url(r'^(?P<pk>\d+)/update/payment/$', views.payment_settings_edit,
        name='site-payment-update'),
